...
<div class="container">
    ...
    <div class="row mt-5">
        <h3 class="text-center text-uppercase section-heading" > Dear <?php echo $_POST['name'] ;?>, thanks for your comment.</h3>
                   ...
                   <div class="row mt-3">
                     <h6 class="text-center" style="color:rgb(0, 109, 91);">If you want to resend a comment, <a href="contact.html" style="text-decoration: none; color :orangered;">click here</a>.</h6>
                   </div>
            </div>
    </div>
    <?php
